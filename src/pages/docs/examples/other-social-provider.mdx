...
<img src="/images/social-auth-other-require.png" alt="Require other social authentication provider" class="rounded-lg shadow-md dark:border dark:border-slate-500 dark:border-opacity-40" />
