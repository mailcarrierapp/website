...
If you're familiar with the most popular JS frameworks, such as *Vue* or *Svelte*, you will find the syntax very easy and friendly: in fact, [**Latte**](https://latte.nette.org/en/syntax) is being used as template engine, providing a fast and expressive way to write your templates.  
