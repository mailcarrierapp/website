...
You can specify a **trigger** to know what application sent that specific email. It's just a plain text field, used only for display and search purposes, but can be very useful when using MailCarrier in a multi-services architecture.
