...
To get started configure your desired disk following the Laravel documentation, for example [install the S3 driver](https://laravel.com/docs/9.x/filesystem#s3-driver-configuration) and set the correct environment variables.
...
<Aside type="note" title="JSON or Form-Data?">
